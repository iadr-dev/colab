...
**Shipping version:** **`0.6.0`** (see `package.json` and Git tag **`v0.6.0`**). For automation, `npm run version:current` is canonical.
...
git add -A && git commit -m "Release version 0.6.0"
